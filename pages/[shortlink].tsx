...
// 3. You are done!
const shortLinks = ['discord', 'il', 'wiki', 'rta', 'ilrules', 'twitch', 'sunshinecommunity', 'yt', 'comsob'] as const;
...
function getHref(shortLinkTarget: ShortLinks): string {
    switch (shortLinkTarget) {
        ...
        case 'rta':
            return 'https://docs.google.com/spreadsheets/d/12wDUXjLqmcUuWSEXWc1fHNJc24KlfyCh0pvibZYEQM0/edit?gid=639987350#gid=639987350&range=A1:B1'        
        case 'ilrules':
            return 'https://smscommunity.github.io/sms-guide/info/il/rules/'      
        case 'twitch':
        ...
        case 'comsob':
            return 'https://docs.google.com/spreadsheets/d/12wDUXjLqmcUuWSEXWc1fHNJc24KlfyCh0pvibZYEQM0/edit?gid=1529893617#gid=1529893617&range=A1'
    }
}
